    ...
    <div class="collapse navbar-collapse pt-3 pb-2 py-lg-0 w-100" id="navigation">
      <ul class="navbar-nav navbar-nav-hover ms-lg-12 ps-lg-5 w-100">
        <li class="nav-item mx-2">
          <a class="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center" href="javascript:;"  aria-expanded="false">
            Paket Foto
          </a>
        ...
        <li class="nav-item my-auto ms-auto">
          <a href="/design/pages/sign-in.html" class="btn btn-sm btn-outline-dark btn-round mb-0 me-1 mt-2 mt-md-0">Sign in</a>
        </li>

        <li class="nav-item my-auto ms-3 ms-lg-0">
          <a href="/design/pages/sign-up.html" class="btn btn-sm text-white  bg-dark  btn-round mb-0 me-1 mt-2 mt-md-0">Sign Up</a>
        </li>
