    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            @if (auth()->user()->role == 'admin')
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->is('admin/packages') ? 'active bg-gradient-dark text-white' : 'text-dark' }}" href="{{ route('paket.index') }}">
            ...
            @elseif(auth()->user()->role == 'member')
                <li class="nav-item">
                    <a class="nav-link {{ request()->is('member/orders') ? 'active bg-gradient-dark text-white' : 'text-dark' }}" href="/member/orders">
                        <i class="material-symbols-rounded me-2">shopping_cart</i>
                        <span class="nav-link-text">Pemesanan</span>
                    </a>
                </li>
